<div class="modal fade" tabindex="-1" role="dialog" id="delete-genre">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Hapus data genre</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form action="{{ route('genres.destroy', 'data') }}" method="post">
            @csrf
            @method('DELETE')
                <input type="hidden" name="id" id="id">
                <input type="text" name="name" class="form-control" disabled readonly placeholder="Nama genre" id="name" value="">
                <p></p>
